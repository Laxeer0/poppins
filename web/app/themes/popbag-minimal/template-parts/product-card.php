...
<article class="group h-full rounded-[16px] border border-[#003745]/10 bg-white p-4 shadow-sm transition-transform hover:scale-[1.03] hover:shadow-lg">
	<a href="<?php echo esc_url($product->get_permalink()); ?>" class="flex h-full flex-col gap-4">
		<div class="relative overflow-hidden rounded-[14px] border border-[#003745]/10 bg-[#003745]/5">
			...
			<div class="relative aspect-[4/5] overflow-hidden">
				<?php echo $product->get_image('woocommerce_single', ['class' => 'h-full w-full object-cover']); ?>
			</div>
		</div>
