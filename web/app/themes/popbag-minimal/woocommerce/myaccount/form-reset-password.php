...
// Woo core passes variables as $key and $login. Keep backward-compatibility with any custom usage.
$reset_key   = isset($key) ? (string) $key : (isset($reset_key) ? (string) $reset_key : '');
$reset_login = isset($login) ? (string) $login : (isset($reset_login) ? (string) $reset_login : '');
?>
