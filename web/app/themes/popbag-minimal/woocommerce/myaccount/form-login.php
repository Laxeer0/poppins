...
<div class="woo-account" id="customer_login">
	<div class="grid gap-8 <?php echo $can_register ? 'md:grid-cols-2' : ''; ?>">
		<div class="rounded-[16px] border border-[#003745]/10 bg-white p-6 shadow-sm">
			...
			<form class="mt-6 space-y-4 woocommerce-form woocommerce-form-login login" method="post" novalidate>
				...
				<div class="flex flex-wrap items-center justify-between gap-4 pt-2">
					...
					<button type="submit" class="<?php echo esc_attr(popbag_classnames(popbag_button_classes('primary', 'md', 'px-5'), 'woocommerce-button button woocommerce-form-login__submit')); ?>" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>">
		...
		<?php if ($can_register) : ?>
			...
			<form method="post" class="mt-6 space-y-4 woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?> >
				...
				<div class="pt-2">
					...
					<button type="submit" class="<?php echo esc_attr(popbag_classnames(popbag_button_classes('secondary', 'md', 'w-full'), 'woocommerce-Button woocommerce-button button woocommerce-form-register__submit')); ?>" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>">
